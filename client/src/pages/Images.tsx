...
const Images = () => {
  ...
  return (
    <>
        ...
        {breedLoading ? (
          ...
          <>
            <Typography variant="h4">
              Images of {catBreeds[0]?.name || "Random Cats"}
            </Typography>
      ...
      <Box>
        {imageLoading ? (
          <Skeleton animation="pulse" variant="rectangular" height={1000} />
        ) : (
          <ImageList
            variant="woven"
            cols={3}
          ...
          >
            {images.map((catImage, index) => (
              ...
              >
                <img src={catImage.url} alt={catImage.id} loading="lazy" />
              </ImageListItem>
            ))}
          </ImageList>
        )}
